...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "echo '🔧 Install Xvfb'",
      "/usr/bin/sudo /home/bwinter_sc81/baroboys/scripts/dependencies/xvfb/apt_xvfb.sh",

      "echo '🔧 Setup Xvfb'",
      "/usr/bin/sudo /home/bwinter_sc81/baroboys/scripts/services/xvfb/refresh.sh",

      "echo '🔧 Install Wine'",
      "/usr/bin/sudo /home/bwinter_sc81/baroboys/scripts/dependencies/wine/apt_wine.sh",
      ...
      "echo VRising | /usr/bin/sudo tee /etc/baroboys/active-game > /dev/null",
