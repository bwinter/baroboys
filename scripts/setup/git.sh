...
[ -d "/root/baroboys" ] || git clone "git@github.com:bwinter/baroboys.git" "/root/baroboys"
...
su bwinter_sc81 -c '[ -d "/home/bwinter_sc81/baroboys" ] || git clone git@github.com:bwinter/baroboys.git "/home/bwinter_sc81/baroboys"'
